...
for (let tipo_espectaculo = 1; tipo_espectaculo < 5; tipo_espectaculo++) {
  const opcion = document.createElement("option");
  opcion.value = tipo_espectaculo;
  if (tipo_espectaculo == 1) {
    opcion.text = "Allegri ma non troppo";
  }
  if (tipo_espectaculo == 2) {
    opcion.text = "Allegri molto";
  }
  if (tipo_espectaculo == 3) {
    opcion.text = "Allegri assai";
  }
...
function convertirDatos() {
  ...
  switch (datos[4]) {
    case "1":
      mostrarDatos[4] = "Musical infantil allegri ma non troppo";
      break;
    case "2":
      mostrarDatos[4] = "Musical infantil allegri molto";
      break;
    case "3":
      mostrarDatos[4] = "Musical infantil allegri assai";
      break;
    case "4":
...
function calcular_pago() {
  ...
  switch (datos[1]) {
    case "1": pay_eat = (18462 * total_invitados);
      break;
    case "2": pay_eat = (14242 * total_invitados);
      break;
    case "3": pay_eat = (11605 * total_invitados);
      break;
    case "4": pay_eat = (8967 * total_invitados);
      break;
    case "5": pay_eat = (15772 * total_invitados);
      break;
    case "6": pay_eat = (29540 * (total_invitados / 2));
      break;
  }
  ...
  switch (siYno[0]) {
    case "0": pay_recor += 0;
      break;
    case "1": pay_recor = (3500 * niños_inv) + (5500 * niñas_inv) + (2500 * maxi_invitados);
      break;
  }
  ...
  switch (siYno[3]) {
    case "0": pay_refri += 0;
      break;
    case "1": pay_refri = (8500 * niños_inv) + (10000 * maxi_invitados);
      break;
  }
  ...
  switch (siYno[4]) {
    case "0": pay_drink += 0;
      break;
    case "1": pay_drink = (mini_invitados * 6500) + (maxi_invitados * 15750);
      break;
  }
  ...
  switch (datos[4]) {
    case "1": pay_arti += 500000;
      break;
    case "2": pay_arti += 1000000;
      break;
    case "3": pay_arti += 1500000;
      break;
    case "4": pay_arti += 0;
      break;
  }
  ...
  switch (siYno[6]) {
    case "0": pay_print += 0;
      break;
    case "1": pay_print = mini_invitados * 1500;
      break;
  }
...
function mostrarCotizacion() {
  ...
  if (is_numeric(mini_invitados) && mini_invitados > 0) {
    if (mini_invitados > 60) {
      ...
      window.alert(
        "Según el número de invitados te recomiendo que requieras una cotización para una piñatica. Redireccionando a la página de piñaticas"
      );
      window.location.assign("pinatica.html");
    }
  } else {
